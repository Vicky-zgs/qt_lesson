...
class Archive extends Component {
  ...
  render() {
    const archive_item = this.state.data.map((item, index) => {
      return (
    ...
    return (
        <Card style={{padding: 30}}>
          <Timeline>
            <Timeline.Item dot={<ClockCircleOutlined />} color="red" style={{lineHeight: '20px'}}>
